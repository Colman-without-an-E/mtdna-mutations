...
int main(int argc, char *argv[]) {
	...
	fprintf(fp_wildtype_population, "sim,cell,t,wildtype_population\n");
	...
	fprintf(fp_wildtype_sfs, "sim,t,mut_id1,mut_id2,...\n");
	...
	// Record initial data
	write_data_to_file_pre_introduce(wildtype_populations, mutant_counts, 0, recording_time, wildtype_population_filename, wildtype_sfs_filename);
